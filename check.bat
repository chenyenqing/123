...
curl -o "C:\Users\Public\Desktop\Readme-create-by-TinHocThucHanh.txt" https://raw.githubusercontent.com/akunmpwr2/Azure_RDP/main/Readme-create-by-TinHocThucHanh.txt > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\SetupBrowser.zip" https://raw.githubusercontent.com/akunmpwr2/Azure_RDP/main/SetupBrowser.zip > out.txt 2>&1
diskperf -Y >nul
